...
<head>
    ...
    <title>Anggaran - Atur Cuan</title>
...
<div class="button-actions">
    ...
    <section id="tabelanggaran" class="section">
        <div class="container">
        ...
        <table class="card-form-table">
            ...
            <?php anggaran($id_pengguna_session) ?>
        </table>
        <div>
            <a href="tambah-anggaran.php"><button>Tambah Anggaran</button></a>
        </div>
    </section>
