...
<head>
    ...
    <title>Atur Cuan - Anggaran Icon Tambah</title>
...
<body>
    ...
    <section id="anggaranIconTambah" class="section">
        <div class="container">

            <div class="content">

                <!-- Card Tambahan Anggaran -->
                <form action="includes/tambah-transaksi.inc.php" method="post" class="card-form anggaran">
                    ...
                    <ul class="card-list-form">
                        ...
                        <li class="card-item-form">
                            ...
                            <div class="card-item-input">
                                <input type="date" id="tanggal-awal" name="tanggal-awal" required>
                            </div>
                        </li>
                        <li class="card-item-form">
                            <label for="tanggal">
                            ...
                            <div class="card-item-input">
                                <input type="date" id="tanggal-akhir" name="tanggal-akhir" required>
                            </div>
                        </li>
                        <li class="card-item-form">
                            <label for="kategori">
                        ...
                        <li class="card-item-form">
                            ...
                            <div class="card-item-input">
                                <input type="text" id="nama-anggaran" name="nama-anggaran">
                            </div>
                        </li>
                        <li class="card-item-form button">
                            <button type="submit" class="btn btn-info" name="tambah-anggaran">
                                Tambah
                            </button>
                        </li>
                    </ul>
