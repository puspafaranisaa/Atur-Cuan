...
<head>
    ...
    <title>Pengeluaran - Atur Cuan</title>
...
<section id="tabelpengeluaran" class="section">
        <div class="container">
        ...
        <table class="card-form-table">
            ...
            <?php pengeluaran($id_pengguna_session) ?>
        </table>
        <div>
            <a href="tambah-pengeluaran.php"><button>Tambah Pengeluaran</button></a>
        </div>
    </section>
