...
<head>
    ...
    <title>Atur Cuan - Laporan Keuangan</title>
    ...
    <section id="laporanKeuangan" class="section">
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="card-form card-table">

                    <div class="card-form-badge">
                        <div class="card-form-badge-title-wrapper">
                            <img src="./assets/icon/savings24-icon.svg" alt="" width="55" height="50">
                    ...
                    <table class="card-form-table">
                        ...
                        <tbody class="card-form-tbody">
                            <?php laporan_keuangan($id_pengguna_session) ?>
                        </tbody>
                    </table>
